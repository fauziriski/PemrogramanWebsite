...
$x = query("SELECT * FROM rating WHERE rating > 0 AND bis = 'ekonomi'");
$jumlahdata = count($x);
$jumlahhalaman = ceil($jumlahdata/$jumlahdataperhalaman);
$halamanaktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awaldata = ($jumlahdataperhalaman * $halamanaktif) - $jumlahdataperhalaman;

$rating = query("SELECT * FROM rating WHERE rating > 0 AND bis = 'ekonomi' LIMIT $awaldata,$jumlahdataperhalaman ");
...
<body>
	...
	<div class= "menu">
	 	<ul>
			...
			<li><a href="penumpang.php">Penumpang Bis Ekonomi</a></li>
			<li><a href="rating.php">Rating Bis Ekonomi</a></li>
